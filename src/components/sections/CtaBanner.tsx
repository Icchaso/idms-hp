  ...
  return (
    <section className="bg-navy-900 text-white relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]" aria-hidden="true">
        <div className="absolute -top-32 -left-32 w-96 h-96 rounded-full border border-gold-500 animate-slow-spin" />
        <div className="absolute -bottom-32 -right-32 w-96 h-96 rounded-full border border-gold-500 animate-slow-spin-reverse" />
      </div>
